...
export const data = new SlashCommandBuilder()
  .setName("checkadmin")
  .setDescription("Checks if player is an admin. Command made mainly for testing.")
...
export async function execute(interaction: CommandInteraction) {
  ...
  if (mcusername && interaction.guildId != null) {
    ...
    if (result) {
      ...
      interaction.reply(interaction.options.getString("nickname") + " is not a server admin")
    }
  }
  //sender
